...
public class english extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
           ...
           questionList = (ArrayList<Question>) dbHelper.getAllQuestions("end");
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()|| rb4.isChecked()) {
                        ...
                        Toast.makeText(english.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal)
        {
            ...
            {
                Toast.makeText(english.this, "Level 1 Finish Your Score is "+String.valueOf(score).toString(), Toast.LENGTH_SHORT).show();
                Toast.makeText(english.this, "Level 2 started ", Toast.LENGTH_SHORT).show();

            }
            else if(questionCounter==20)
            {
                Toast.makeText(english.this, "Level 2 Finish Your Score is "+String.valueOf(score).toString(), Toast.LENGTH_SHORT).show();
                Toast.makeText(english.this, "Level 3 started ", Toast.LENGTH_SHORT).show();
    ...
    private void finishQuiz() {
        ...
        Intent i1=new Intent(this,result.class);
        i1.putExtra("score",String.valueOf(score).toString());
        startActivity(i1);
    }
